...
This example shows a longer technical PDF with sections, event lists, references, and figures.
...
- Input type: PDF
- Source size: 4,832,531 bytes
- PDF pages: 18
- Converted Markdown: 23,172 bytes
- Result ZIP: 834,762 bytes
